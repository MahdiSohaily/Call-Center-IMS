                ...
                <?php foreach ($dollarRate as $rate) : ?>
                    <tr class="odd:bg-gray-200">
                        ...
                        <td class='p-2 rtl text-center'>
                            ...
                            <?php endif; ?>
                            <button onclick="editItem(<?= $id ?>)" class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
                                ویرایش
                            </button>
                        </td>
                    </tr>
    ...
    <div class="rtl">
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input name="rate" value="" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="درصد دلار" required>
            </div>
            <div class="w-full md:w-1/2 px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                    بازه اول
                </label>
                <input name="date" value="" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="date" placeholder="اعمال تا تاریخ" required>
            </div>
            <div class="w-full md:w-1/2 px-3">
