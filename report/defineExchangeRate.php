    ...
    <div class="rtl">
        ...
        <div class="flex flex-wrap mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input id="edit_rate" name="rate" value="" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="درصد دلار" required>
            </div>
            <div class="w-full md:w-1/2 px-3">
